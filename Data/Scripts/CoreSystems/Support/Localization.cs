            ...
            {
                {
                    MyLanguagesEnum.English, new Dictionary<string, string>
                    {
                        ...
                        { "TerminalShootTitle", "Shoot (Legacy)" },
                        ...
                        { "ActionFire", "Shoot (Key Shoot Modes)" },
                        { "ActionShoot", "Shoot On/Off (Legacy)" },
                        { "ActionShoot_Off", "Shoot Off (Legacy)" },
                        { "ActionShoot_On", "Shoot On (Legacy)" },
                ...
                },
               {
                    MyLanguagesEnum.Russian, new Dictionary<string, string>
                    {
                        ...
                        { "Overload Toggle On/Off", "Переключить Перегрузка Вкл/Выкл " },
                        { "Overload On", "Переключить Перегрузка Вкл" },
                        ...
                        { "TerminalUnownedTitle", "Стрелять по целям без владельца" },
                        ...
                        { "TerminalProjectilesTooltip", "Вести огонь по приближающимся снарядам" },
                        { "TerminalMeteorsTitle", "Наводить на метеориты" },
                        { "TerminalMeteorsTooltip", "Наводить на метеориты" },
                        { "TerminalGridsTitle", "Наводить на большие/малые блоки" },
                        { "TerminalGridsTooltip", "Наводить на большие/малые блоки" },
                        { "TerminalFocusFireTitle", "Фокусировать огонь" },
                        { "TerminalFocusFireTooltip", "Сосредоточить весь огонь на указанной цели" },
                        { "TerminalSubSystemsTitle", "Наводить на подсистемы" },
                        { "TerminalSubSystemsTooltip", "Наведение на подсистемы объекта" },
                        ...
                        { "TerminalCameraChannelTooltip", "Оружейная камера проецирует целевой индикатор опережения" },
                        { "TerminalBurstShotsTitle", "Burst Shot Count" },
                        { "TerminalBurstShotsTooltip", "The number of shots to burst at a time" },
                        { "TerminalTargetGroupTitle", "Ведущая оружейная группа" },
                        { "TerminalTargetGroupTooltip", "Установите идентичные цифры на Оружейной камере для проекции целевого индикатора" },
                        { "TerminalDecoyPickSubSystemTitle", "Имитировать подсистему" },
                        { "TerminalDecoyPickSubSystemTooltip", "Выберите, какую подсистему будет имитировать эта приманка" },
                        { "TerminalCameraCameraChannelTitle", "Оружейный канал камеры" },
                        { "TerminalCameraCameraChannelTooltip", "Установите индентичные цифры на Ведущей оружейной группе для проекции целевого индикатора" },
                        ...
                        { "ActionNextCameraChannel", "Следующий оружейный канал" },
                        ...
                        { "WeaponInfoRealDps", "Стандартный УВС" },
                        { "WeaponInfoPerfectDps", "Идеальный УВС" },
                        { "WeaponInfoPeakDps", "Максимальный УВС" },
                        { "WeaponInfoBaseDps", "Базовый УВС" },
                        { "WeaponInfoAreaDps", "По площади УВС" },
                        { "WeaponInfoExplode", "Взрывной УВС" },
